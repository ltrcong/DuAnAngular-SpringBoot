...
export class OrderComponent implements OnInit{
  ...
  constructor(
    ...
    this.orderForm = this.fb.group({
      full_name: ['Lê Trọng Công', Validators.required], // updated to match template
      email: ['letrongcong11062003@gmail.com', [Validators.email]], 
      phone_number: ['0586222224', [Validators.required, Validators.minLength(10)]],
      address: ['Nguyễn Thái Học, tp.Quy Nhơn', [Validators.required, Validators.minLength(20)]], 
      note: ['dêc vỡ'],
